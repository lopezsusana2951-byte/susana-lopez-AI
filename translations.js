  ...
  window.T = {
    ...
    en: {
      ...
      social: {
        ...
        handle: '@susana.lopez.miami',
        posts: [
          { title: 'Just Listed',     caption: 'Bayfront residence — 5 BR · Brickell',    es: 'Frente al mar · Brickell' },
          { title: 'Sunset Tour',     caption: 'Penthouse · Sunny Isles',                  es: 'Atardecer en el penthouse' },
          { title: 'Open House',      caption: 'Saturday · 2pm · Coconut Grove',           es: 'Sábado · 2pm' },
          { title: 'New to Market',   caption: 'Waterfront estate · Star Island',          es: 'Nuevo al mercado' },
          { title: 'Coming Soon',     caption: 'Pre-construction · Edgewater',             es: 'Próximamente' },
      ...
      signature: {
        ...
        quote: "Precision AI. A director's eye. A decade spent understanding what moves luxury buyers. Every frame I deliver is built to make someone feel a property before they've stepped inside it.",
    ...
    es: {
      ...
      social: {
        ...
        handle: '@susana.lopez.miami',
        posts: [
          { title: 'Recién Publicado',    caption: 'Residencia frente al mar — 5 hab · Brickell', es: 'Frente al mar · Brickell' },
          { title: 'Tour al Atardecer',   caption: 'Penthouse · Sunny Isles',                     es: 'Atardecer en el penthouse' },
          { title: 'Casa Abierta',        caption: 'Sábado · 2pm · Coconut Grove',                es: 'Sábado · 2pm' },
          { title: 'Nuevo en el Mercado', caption: 'Residencia frente al agua · Star Island',     es: 'Nuevo al mercado' },
          { title: 'Próximamente',        caption: 'Preconstrucción · Edgewater',                  es: 'Próximamente' },
      ...
      signature: {
        ...
        h2em: 'LA VISIÓN ES',
        h2line3: 'MI FIRMA.',
        quote: 'IA de precisión. El ojo de una directora. Una década entendiendo qué mueve a los compradores de lujo. Cada fotograma que entrego está construido para hacer que alguien sienta una propiedad antes de haberla pisado.',
        sigName: 'Susana Lopez',
